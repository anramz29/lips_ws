...
This comprises the packages that are currently being used in the lips lab. Currently finished the preliminary [search alogrithim](/move_to_pose/launch/scan_and_approach.launch)
